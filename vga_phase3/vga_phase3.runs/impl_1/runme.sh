...
HD_PWD='C:/Users/micha/Documents/Xilnux/VGA/vga_phase3/vga_phase3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_phase3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_phase3.tcl -notrace
