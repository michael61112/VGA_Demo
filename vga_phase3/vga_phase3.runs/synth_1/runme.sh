...
HD_PWD='C:/Users/micha/Documents/Xilnux/VGA/vga_phase3/vga_phase3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_phase3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_phase3.tcl
