...
HD_PWD='C:/Users/micha/Documents/Xilnux/VGA/vga_phase3/vga_phase3.runs/blk_mem_gen_index_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_index.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_index.tcl
