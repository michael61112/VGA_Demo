...
#create_clock -add -name clk -period 10.00 -waveform {0 5} [get_ports { clk50  }];
...
## Buttons
#set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
...
#set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports { count_v }]; #IO_L5N_T0_D07_14 Sch=ck_io[31]
#set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { count_h }]; #IO_L13N_T2_MRCC_14 Sch=ck_io[32]
