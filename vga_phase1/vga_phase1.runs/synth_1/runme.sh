...
HD_PWD='C:/Users/micha/Documents/Xilnux/VGA/vga_phase1/vga_phase1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_phase1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_phase1.tcl
