...
HD_PWD='C:/Users/micha/Documents/Xilnux/VGA/vga_phase1/vga_phase1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_phase1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_phase1.tcl -notrace
